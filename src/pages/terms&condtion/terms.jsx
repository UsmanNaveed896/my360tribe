    ...
    <div className='main'>
      ...
      <div className='flex justify-center bg-[#15214c] '>
        <div className='max-w-[800px]'>
          <h1 className='text-white text-5xl mt-16 text-center'>Terms And Condition </h1>
          ...
          <div className='flex justify-end gap-4 mt-4'>
              <button className='py-2 px-5 bg-transparent border rounded text-white'>Cancel</button>
